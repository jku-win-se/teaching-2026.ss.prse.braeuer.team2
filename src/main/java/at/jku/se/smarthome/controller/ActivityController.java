...
public class ActivityController {
    ...
    public void openVacationMode() {
        try {
            FXMLLoader loader = new FXMLLoader(
                    ActivityController.class.getResource("/at/jku/se/smarthome/fxml/vacation-mode-view.fxml")
            );
            Scene scene = new Scene(loader.load(), 1000, 600);
            Stage stage = (Stage) activityListContainer.getScene().getWindow();
            stage.setScene(scene);
    ...
    public void openSimulation() {
        try {
            FXMLLoader loader = new FXMLLoader(
                    ActivityController.class.getResource("/at/jku/se/smarthome/fxml/simulation-view.fxml")
            );
            Scene scene = new Scene(loader.load(), 1000, 600);
            Stage stage = (Stage) activityListContainer.getScene().getWindow();
            stage.setScene(scene);
